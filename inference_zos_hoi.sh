...
do
    PROMPT=${PROMPTS[$i]}
    CUDA_VISIBLE_DEVICES=2,3 python main_zos.py --verifier_to_use="qwen" --pipeline_config_path=configs/sd1.5.json --prompt="$PROMPT" --num_prompts=None --search_rounds=3 --n_candidates=5 --d_metric="euclidean" --lambda_val=60 --lambda_dec_round=0.5 --max_new_tokens=1600
done
...
do
    PROMPT=${PROMPTS[$i]}
    CUDA_VISIBLE_DEVICES=2,3 python main_zos.py --verifier_to_use="qwen" --pipeline_config_path=configs/sdxl.json --prompt="$PROMPT" --num_prompts=None --search_rounds=3 --n_candidates=5 --d_metric="euclidean" --lambda_val=60 --lambda_dec_round=0.5 --max_new_tokens=1600
done
...
do
    PROMPT=${PROMPTS[$i]}
    CUDA_VISIBLE_DEVICES=2,3 python main_zos.py --verifier_to_use="qwen" --pipeline_config_path=configs/flux.1_dev.json --prompt="$PROMPT" --num_prompts=None --search_rounds=3 --n_candidates=5 --d_metric="euclidean" --lambda_val=60 --lambda_dec_round=0.5 --max_new_tokens=1600
done